    ...
    for root, directory_names, filenames in os.walk(top_level_directory):
        ...
        for filenm in filenames:
            if logfile_pattern in filenm :
                ...
                metadata.at[rownum, 'DepositDescription'] = deposit_title_prefix + "Data generated by team member: " + person_name + " in folder: " + current_folder  + ". ". Metadata compiled automatically by prepare_deposits_for_vault.py."
                ...
                if match_date: 
                    metadata.at[rownum, 'DepositTitle'] = deposit_title_prefix + person_name + " (" + year_name + ") " + current_folder
                    metadata.at[rownum, 'DepositDescription'] = deposit_title_prefix + "Data generated by team member: " + person_name + " in date-labelled folder: " + current_folder  + ". Deposit contains files that were stored in " + root + ". Metadata compiled automatically by prepare_deposits_for_vault.py."
                    metadata.at[rownum, 'PathToFiles'] = root 
                    rownum += 1 
