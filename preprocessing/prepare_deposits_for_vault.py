...
def main():
    ...
    date_folder_pattern = "DD-Mmm-YYYY" # Swain lab dated folders DD-Mmm-YYYY eg 23-Jan-2017
    ...
    for root, directory_names, filenames in os.walk(top_level_directory):
        ...
        if "-" in current_folder[2] and "-" in current_folder[6] and current_folder.__len__ = 11
